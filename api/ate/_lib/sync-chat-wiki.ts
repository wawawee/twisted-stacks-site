...
function defaultChatMd() {
  return `# Colab chat — ATE teamlogg

Auto-sync från ATE colab (\`twistedstacks.com/ate\`).
Investerare, strategi, data, risk och dev — korta diskussioner och beslut.
...
**Status:** auto-sync från ATE colab chat  
**Author:** @${input.member}  
**Date:** ${date}  
**Chat:** #${input.id}
