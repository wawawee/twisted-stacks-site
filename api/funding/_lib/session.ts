...
export const COOKIE_NAME = "funding_session";
export const MEMBER_COOKIE = "funding_member";
...
export function getRoomPassword() {
  return readEnv("FUNDING_ROOM_PASSWORD") || "funding123";
}

function getSessionSecret() {
  return readEnv("FUNDING_ROOM_SECRET") || getRoomPassword();
}
...
export function devAuthSkipped() {
  const v = readEnv("FUNDING_DEV_SKIP_AUTH");
  return v === "1" || v === "true";
}
