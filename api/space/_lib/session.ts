...
export const COOKIE_NAME = "space_session";
...
export function getRoomPassword() {
  return readEnv("SPACE_ROOM_PASSWORD") || "space123";
}

function getSessionSecret() {
  return readEnv("SPACE_ROOM_SECRET") || getRoomPassword();
}
...
export function devAuthSkipped() {
  const v = readEnv("SPACE_DEV_SKIP_AUTH");
  return v === "1" || v === "true";
}
