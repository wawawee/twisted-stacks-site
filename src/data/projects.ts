...
export const PROJECTS: ProjectEntry[] = [
  /* ---------- 1. REVISION / SkatteRevision ---------- */
  {
    ...
    taglineSv:
      "Lead-intelligens för retroaktiv svensk skatteåtervinning — inte org.nr-uppslag.",
    descriptionSv:
  ...
  /* ---------- 2. LAGA ---------- */
  {
    ...
    descriptionSv:
      "LAGA är en experimentell svensk juridisk AI-workflow-plattform som omvandlar långformats juridisk media till strukturerat granskningsmaterial. Ljud och video flödar genom en fyra-nods React Flow-graf — Media, Transcribe, Analyze, Eval — med run-monitor och spårbara artefakter under varje run-mapp. Lokal MLX Whisper hanterar svensk speech-to-text på Apple Silicon med duty-budgeterad GPU-profil; OpenRouter fungerar som fallback för text- och multimodal granskning. Poängen är workflow, inte chatt.",
    longDescriptionSv:
      "LAGA är en experimentell juridisk AI-arbetsflödes-plattform som omvandlar långformats juridisk media till strukturerat granskningsmaterial via en fyra-nods React Flow-graf. Kodnamn Legal AI Gateway Architecture. v0.1-MVP:n är en fyra-nods graf: Media → Transcribe → Analyze → Eval, byggd i ett pnpm-monorepo med Vite + React Flow på webbsidan och Hono på API-sidan.\n\nLjud och video kommer in, lokal MLX-transkribering kör på Apple Silicon, systemet detekterar inter- och intra-talar-motsägelser, och OpenRouter-baserad granskning kopplar påståenden till SFS-lagrum. Poängen är inte en generisk chatbot — ärenden rör sig genom explicita noder med run-monitor och spårbara artefakter, så en jurist kan se exakt vad som transkriberades, vad som påstods och vad som motsades. Demo-ljudet är ett svenskt förhörs-klipp med intra- och inter-talar-motsägelser inbyggda, och Contradictions-panelen filtrerar på talar-relation.\n\nMLX-integrationen behandlas som duty-budgeterad medborgare: MLX_GPU_DUTY_TARGET=0.8, MAX_CONCURRENT_MLX=1 och MLX_CHUNK_COOLDOWN_MS håller GPU:n sval under sustained load. OpenRouter är fallback-vägen för text och multimodal granskning när lokal MLX inte räcker.\n\nDen senaste macOS Swift-shellen ligger på en privat iMac och är inte publikt deploybar idag. En Almi Verifieringsmedel-ansökan är ute; det primära långsiktiga finansieringsmålet är Vinnova Innovativa Startups 2026. Framtida noder inkluderar ett Legal RAG-lager med source IDs, en Praxis-webbläsar-agent och en synkad macOS-skal som delar samma workflow-JSON.",
    faqSv: [
      {
        q: "Vad är LAGA och vad gör det?",
        a: "LAGA är en experimentell juridisk AI-arbetsflödes-plattform som tar långformats juridisk media (ljud/video från förhör, intervjuer, utsagor) och omvandlar det till strukturerat granskningsmaterial. Transkribering sker lokalt med MLX på Apple Silicon; motsägelser inom och mellan talare detekteras automatiskt; OpenRouter kopplar påståenden till SFS-lagrum.",
      },
      {
        q: "Vem är LAGA till för?",
        a: "Advokater, åklagare, utredare och forskningsgrupper som redan arbetar med källmaterial och behöver ett spårbart arbetsflöde — inte konsumenter som vill chatta med en juridisk bot.",
  ...
  /* ---------- 3. Relay / THE-AI-BUTTON ---------- */
  {
    ...
    longDescriptionLang: "en",
    taglineSv:
      "Säg det en gång. Låt agenten göra resten.",
    descriptionSv:
      "Relay är en röst-först iOS-app som skickar talade uppgifter till påminnelser, e-post, n8n-workflows eller AI-agenter utan att någonsin öppna ett chatt-fönster. Hela poängen är att hoppa över friktionen att starta en app och skriva — istället triggar en enda fras (via Hej Siri, Action Button eller Voice Control) Note to AI eller Note to Self.",
    longDescriptionSv:
      "Relay är en röst-först iOS-app som skickar talade uppgifter till agenter, påminnelser eller e-post utan att öppna en chatt. Kallad THE-AI-BUTTON. Hela poängen är att hoppa över chatt-fönstret: istället för att öppna en app, skriva ett meddelande och vänta på svar, triggar du agenten med en enda fras och hör svaret uppläst via TTS. Ingen prenumeration, ingen chatt, ingen copy-paste till ett annat verktyg.\n\n Produkten exponerar exakt två kommandon. Note to AI POST:ar transkriberingen till din egen webhook — typiskt ett n8n-workflow — som kör agenten och returnerar ett kort svar som Relay läser upp. Note to Self sparar samma transkribering till en påminnelselista eller e-post. Båda vägarna är designade för enhands-användning på byggarbetsplats, i verkstad eller där en svensk hantverkare gör riktigt arbete och inte ska fumla med en chatt-app.\n\nIntegrations-lagret är det ingen annan sätter ihop. Relay kopplar ihop Apples egna bitar — Hej Siri, Action Button, Voice Control och App Intents — till ett enda installerbart flöde. Setup-wizarden kopplar in webhook-URL, påminnelsemål och svenskt STT-locale (sv-SE on-device, ingen molnuppladdning). Referens-n8n-workflödet skickar den talade uppgiften genom en Intent Parser, skriver en rad till Airtable och kan fan-out:a till 46elks SMS för kvittens.\n\nBygget är Swift + SwiftUI på iOS 18+, genererat med Xcodegen, bundle id com.perbrinell.relay. Planerad monetisering är engångsköp (~$0.99) — uttryckligen anti-prenumeration. Nuvarande finansieringsspår är Almi Verifieringsmedel, med Vinnova Innovativa Startups 2026 som längre sikt.",
    faqSv: [
      {
        q: "Vad är Relay / THE-AI-BUTTON?",
        a: "Relay är en röst-först iOS-app som skickar talade uppgifter till en agent (Note to AI) eller sparar dem som påminnelse/e-post (Note to Self) — utan att du öppnar en chatt. Målet är att hoppa över fönstret helt: tala in en uppgift, få svaret uppläst av TTS.",
