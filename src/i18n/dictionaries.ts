...
const en: Dictionary = {
  meta: {
    ...
    description:
      "TwistedStacks builds useful AI systems and labs: REVISION, LAGA, Anslag, VR Super-Senses, CymWave, Recon Search Assistant, and selected web work.",
    ogDescription:
      "A clean showroom for TwistedStacks projects: legal AI, grant discovery, VR sensor overlays, hydro-wellness research, OSINT/search support, and playable TWISTED PONGG.",
  },
  topbar: {
    languageToggle: "EN",
    languageName: "en",
...
const sv: Dictionary = {
  meta: {
    ...
    description:
      "TwistedStacks bygger användbara AI-system och labb: REVISION, LAGA, Anslag, VR Super-Senses, CymWave, Recon Search Assistant och utvalda webbprojekt.",
    ogDescription:
      "En ren showroom för TwistedStacks-projekt: juridisk AI, anslagssökning, VR-sensoroverlay, hydro-wellness-forskning, OSINT/search-stöd och spelbara TWISTED PONGG.",
  },
  topbar: {
    languageToggle: "SV",
    languageName: "sv",
